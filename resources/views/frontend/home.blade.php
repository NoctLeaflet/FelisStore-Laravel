            ...
            <div class="row">
                <div class="col-lg-6 p-0">
                    <div class="categories__item categories__large__item set-bg"
                        data-setbg="{{ asset('me') }}/img/pardoHome.png">
                        <div class="categories__text">
                            <p>Beragam Official Merchandise Honkai Impact 3rd </p>
                            <p>Yang Di Produksi Langsung Oleh Hoyoverse</p>
                            <a href="{{ route('product.index') }}">Jelajahi Sekarang</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 mix {{ $new_categories2->slug }}">
                            @component('components.frontend.product-card')
                                ...
                                @slot('route', route('product.show', ['categoriSlug' => $new_categories2->slug, 'productSlug' =>
                                    ...
                                    @slot('price',"Rp.".number_format($product->price))
                                @endcomponent
                            </div>
                        @endforeach
                    @endforeach
